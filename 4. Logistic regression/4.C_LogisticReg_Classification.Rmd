...
1. Symmetric cost function (misclassification rate) with 1:1 cost ration, or equivalently pcut=1/2 
...
#Asymmetric cost, with pcut NOT in the function input argument (This will be used later for cross validation for Credit Card default case.)
