...
# (Taiwan) Credit Card Default Data
...
We first load the credit scoring data. It is easy to load comma-separated values (CSV). The credit data in this lab is a subsample (n=12,000 rows) of the full credit UCI data (n=30,000). 
```{r}
