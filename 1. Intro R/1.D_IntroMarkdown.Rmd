...
4. hyperlinks - create a hyperlink like this [Data-Mining](https://yanyudm.github.io/Data-Mining-R/).

```
# Say Hello to **Data Mining** in Markdown

* [Data Mining in R on Github](https://yanyudm.github.io/Data-Mining-R/)
